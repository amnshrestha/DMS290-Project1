  ...
  <main class="box">
    ...
    <section>
      ...
      <section>
        ...
        <p>Yangzhou has one Yangtze River crossing, the Runyang Yangtze River Bridge complex, which has one of the longest suspension bridge spans in the world, and carries the G4011 Yangzhou–Liyang Expressway to Zhenjiang.
        </p>
        <img src="https://upload.wikimedia.org/wikipedia/commons/4/42/Yangzhou_Railway_Station_-_P1070063.JPG " alt="Yangzhou railway station" class="restrict1"/>
        <p>The city is served by an extensive network of public bus routes.vYangzhou's taxi industry began in 1982, and has developed rapidly since 1993. the city has over 40 taxi companies of various ownership structures, with a total of 1,571 vehicles. Parking lots were established at key stations and hotels, and eight taxi companies have opened round-the-clock telephone service. The construction department of the municipal government has strengthened the management of taxi services, providing education in the relevant laws, professional ethics and safety aspects.</p>
    ...
    <section>
      ...
      <section>
        ...
        <p>Guangling , the first settlement in the Yangzhou area, was founded in the Spring and Autumn period. After the defeat of Yue by King Fuchai of Wu, a garrison city was built 12 m above the water level on the north bank of the Yangtze c. 485 BC. This city in the shape of a three by three li square was named Hancheng. </P>
        <p> The newly built Han canal formed a moat around the south and east sides of the city. The purpose of Hancheng was to protect Suzhou from naval invasion from Qi. During the Han dynasty, Guangling was the seat of Guangling Commandery. It constituted a part of the Xu Province, rather than the Yang Province, which was covered the entire southeastern part of China then. In 590, the city was made the capital of a newly established Yang Prefecture, and began to be referred to with its current name.</p>
    ...
    <section>
      ...
      <h4>Tomb of Puhaddin</h4>
      <p>This is essentially a Ming Dynasty graveyard that includes the tomb of Puhaddin. According to information at the tomb, he was a 16th generation descendant of Muhammad, The Prophet. The tomb is on the eastern bank of the (Old) Grand Canal in the eastern sector of the city and is adjacent to a mosque which houses a collection of valuable materials documenting China's relations with Muslim countries</p>
    </section>
  </main> <!-- .box -->
